...
async def coletar_marcas():
    async with async_playwright() as p:
        ...
        await page.focus('div.chosen-container#selectMarcamoto_chosen > a')
        await page.click('div.chosen-container#selectMarcamoto_chosen > a')
        await asyncio.sleep(2)
        await page.wait_for_selector('div.chosen-container#selectMarcamoto_chosen ul.chosen-results > li',
                                     state='attached', timeout=20000)

        # Captura as marcas
        marcas_elements = await page.query_selector_all('div.chosen-container#selectMarcamoto_chosen ul.chosen-results > li')
        ...
        logging.info("Arquivo marcas.xlsx salvo com sucesso!")
