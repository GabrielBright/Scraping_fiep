...
if __name__ == "__main__":
    ...
    arquivos = glob.glob("Fipe_temp_teste*.xlsx")  # ou "Fipe_temp_worker*.xlsx" se preferir
    dfs = []
    for f in arquivos:
        try:
    ...
    if dfs:
        ...
        final.to_excel("Fipe_temp_final.xlsx", index=False)
        print(" Arquivo final salvo como Fipe_temp_final.xlsx")
    else:
